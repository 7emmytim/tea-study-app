...
export const part_one = {
    ...
    questions: [
        {
            q: "_ has several shades and variations",
            a: "Materialsm",
        },
        {
            q: "Materialsm is fundamentally about having the right or wrong _ in the right or wrong _",
            a: "value, proportion",
        },
        {
            q: "At the heart of materialism, what we can see as the root cause is a _",
            a: "value system",
        },
        {
            q: "Everything does not have the same _",
            a: "value",
        },
        {
            q: "To value everything with the same measure, it can lead to _",
            a: "error",
        },
        {
            q: "Wrong valuation is a proof of poor _ which shows a deficiency in _",
            a: "judgment, knowledge",
        },
        {
            q: "The profit in the scriptures is primarily for _",
            a: "doctrine",
        },
        {
            q: "_ is what binds us together",
            a: "doctrine",
        },
        {
            q: "Doctrine is the standard of _",
            a: "correctness",
        },
        {
            q: "_ is the junction where we all meet",
            a: "Doctrine",
        },
        {
            q: "Once we lose that covering of doctrine, our _ and _ is gone",
            a: "safety, sanity",
        },
        {
            q: "Once you come out of the umbrella of doctrine, _ is gone",
            a: "sanity",
        },
        {
            q: "That knowledge of Christ in all he was, all he is and all he shall be, that is _",
            a: "doctrine",
        },
        {
            q: "Doctrine will show you what to stick with amidst the plenty _ in this Bible",
            a: "experiences",
        },
        {
